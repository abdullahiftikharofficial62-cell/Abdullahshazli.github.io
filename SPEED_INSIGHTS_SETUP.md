...
### For Next.js, SvelteKit, Remix, Create React App, Nuxt, Vue, and Astro
...
#### Optionally: Remove Sensitive Information from URLs
...
For more details, see [Learn more about `beforeSend`](/docs/speed-insights/package#beforesend).
